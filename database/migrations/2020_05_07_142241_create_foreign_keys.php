...
class CreateForeignKeys extends Migration {
	...
	public function down()
	{
		...
		Schema::table('cities', function(Blueprint $table) {
			$table->dropForeign('cities_govern_id_foreign');
		});
		Schema::table('posts', function(Blueprint $table) {
		...
		Schema::table('donation_reqs', function(Blueprint $table) {
			$table->dropForeign('donation_reqs_city_id_foreign');
		});
		Schema::table('donation_reqs', function(Blueprint $table) {
			$table->dropForeign('donation_reqs_blood_type_id_foreign');
		});
		Schema::table('client_post', function(Blueprint $table) {
		...
		Schema::table('client_govern', function(Blueprint $table) {
			$table->dropForeign('client_govern_client_id_foreign');
		});
		Schema::table('client_govern', function(Blueprint $table) {
			$table->dropForeign('client_govern_govern_id_foreign');
		});
		Schema::table('blood_type_client', function(Blueprint $table) {
