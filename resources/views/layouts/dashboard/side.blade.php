  ...
  <aside class="main-sidebar" style="background: #000">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li  class="moha" ><a style="color:rgb(255, 255, 255)" href="{{route("dashboard.index")}}"><i class="fa fa-home"></i> <span> الرئيسية</span></a></li>
        ...
        <li  class="moha" ><a style="color:rgb(255, 255, 255)" href="{{route("bloodTypes.index")}}"><i class="fa fa-book"></i> <span>@lang('site.bloodTypes') </span></a></li>
        ...
        <li  class="moha" ><a style="color:rgb(255, 255, 255)" href="{{route("donationReqs.index")}}"><i class="fa fa-heart"></i> <span>@lang('site.donationReqs') </span></a></li>
        <li  class="moha" ><a style="color:rgb(255, 255, 255)" href="{{route("profile.index")}}"><i class="fa fa-user"></i> <span>@lang('site.profile') </span></a></li>
        <li  class="moha" ><a style="color:rgb(255, 255, 255)" href="{{route("users.index")}}"><i class="fa fa-users"> </i><span>@lang('المشرفين') </span></a></li>
        <li  class="moha" ><a style="color:rgb(255, 255, 255)" href="{{route("roles.index")}}"><i class="fa fa-list"></i> <span>@lang('رتب المشرفين') </span></a></li>
